// ISO country/territory codes; country selection is a display preference, not billing evidence.
...
export const COUNTRY_PREFERENCE_KEY = 'bfl-country-preference-v1';
